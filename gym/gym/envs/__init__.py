...
register(
    id='ECglass-v0',
    entry_point='gym.envs.toy_text:EcGlassEnv',
    max_episode_steps=3499,
    reward_threshold=5147,
)
register(
    id='ECglass-v2',
    entry_point='gym.envs.toy_text:EcGlassEnv_v2',
    max_episode_steps=8760,
    reward_threshold=8760,
)
register(
    id='ECglass-v3',
    entry_point='gym.envs.toy_text:EcGlassEnv_v3',
    max_episode_steps=8760,
    reward_threshold=8760,
)
register(
