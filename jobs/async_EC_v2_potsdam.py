...
if __name__ == "__main__":
    ...
    run_experiments(
        {
            "asynchyperband_EC_dqn_v2_potsdam": {
                "run": 'DQN',
                "env":'ECglass-v2',
                "stop": {
                ...
                "config": {
                    "hiddens":tune.grid_search([[4096,2048],[5120,2048],[6000,2048]]),
                    "callbacks": {
                    ...
                    "train_batch_size":tune.grid_search([225,250,275]),
                    "gamma":0,
                    "exploration_final_eps":tune.grid_search([0.01,0.005]),
                    #"exploration_final_eps": 0.05,
                    #"num_workers": 2,
                    "lr": tune.grid_search([0.000001,0.00005]),
                    "target_network_update_freq":tune.grid_search([25000,32000]),
                    "timesteps_per_iteration": 8760,
                    "schedule_max_timesteps": 700000

                },
                "checkpoint_freq": 1,
                "local_dir": "/scratch/kalyanam/ray_results"
            }
        },
        scheduler=ahb)
